...
from copa.utils.app_utils.error_handler import errors
from copa.utils.responses.common import ERROR_RESPONSES
    ...
    def __enter__(self):
        ...
        while soft_deleted:
            try:
                ...
                message = f'Habaye ikibazo, mwongere mugerageze, {str(e)}'
